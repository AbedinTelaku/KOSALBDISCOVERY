...
public interface BusinessRepository extends JpaRepository<Business,Integer> {
   ...
   // @Query(value = "update business set business_id=:businessId,business_activity=:businessActivity,business_number=:businessNumber,email=:email,fiscal_Number=:fiscalNumber,name=:name,owner_id=:ownerId,password=:password,tel_number=:telNumber,username=:username,status=:status,role=:role where business_id=:id",nativeQuery = true)
  //  public void updateBusiness(@Param("id") int id, @Param("businessId") String businessId, @Param("businessActivity") String businessActivity, @Param("businessNumber") String businessNumber,@Param("email") String email,@Param("fiscal_Number") String fiscal_Number,@Param("name") String name,@Param("ownerId") String ownerId,@Param("password") String password,@Param("telNumber") String telNumber,@Param("username") String username,@Param("status") String status,@Param("role") String role);
